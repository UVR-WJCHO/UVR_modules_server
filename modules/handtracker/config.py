...
class Config:
    ...
    checkpoint = './modules/handtracker/checkpoint/SAR_AGCN4_cross_wBGaug_extraTrue_resnet34_s0_Epochs50/checkpoint.pth'
    # checkpoint = './handtracker/checkpoint/SARTE_wHOG_s0_extraTrue_resnet34_s0_Epochs50/checkpoint.pth'
